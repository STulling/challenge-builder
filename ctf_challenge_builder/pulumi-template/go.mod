...
replace github.com/ctfer-io/chall-manager/sdk => github.com/stulling/chall-manager/sdk v0.5.8
replace github.com/ctfer-io/chall-manager/sdk/kubernetes => github.com/stulling/infra/apps/chall-manager/sdk/kubernetes v0.5.8
